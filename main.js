...
function showNextQuestion() {
    ...
    if (currentQuestionIndex === questions.length - 1) {  // if user is at last question
...
function recolorClickedButton(clickedButton) {
    ...
    if (clickedButton.dataset.correct) { // if button you clicked is the correct turn to green
...
function disableAllAnswerButtons() {   // after selecting an answer, it disables all other answers
